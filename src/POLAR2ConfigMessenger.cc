...
POLAR2ConfigMessenger::POLAR2ConfigMessenger(POLAR2GlobalConfig* theGlobalConfig) {
...
POLAR2ConfigMessenger::~POLAR2ConfigMessenger() {
...
void POLAR2ConfigMessenger::SetNewValue(G4UIcommand* command, G4String newValue) {
