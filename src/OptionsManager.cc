...
void OptionsManager::print_version() {
    cout << endl;
    cout << "    " << SW_NAME << " - POLAR-2 Simulation" << endl;
    cout << "    " << SW_VERSION << " (" << RELEASE_DATE << ", compiled " << __DATE__ << " " << __TIME__ << ")" << endl;
    cout << endl;
    cout << " Copyright (C) 2021 POLAR-2 Simulation Group" << endl;
    cout << endl;
    cout << " Main Contributors: " << endl;
    cout << " - Zhengheng Li <lizhengheng@ihep.ac.cn>" << endl;
    cout << " - Merlin Kole <Merlin.Kole@unige.ch>" << endl;
    cout << " - Nicolas De Angelis <Nicolas.DeAngelis@unige.ch>" << endl;
    cout << endl;
}
